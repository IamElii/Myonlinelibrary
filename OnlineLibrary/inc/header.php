	...
	<div class="section catalog random">
			...
			<div class="wrapper">
				...
				<h2>May we suggest something?</h2>
								...
								<ul class="items">
						<li><a href="details.php?id=201"><img src="img/media/hungergames.jpg" alt="Hunger Games">
						<p>View Details</p></a></li>

						<li><a href="details.php?id=204"><img src="img/media/gatsby.jpg" alt="The Great Gatsby">
							<p>View Details</p></a></li>

							<li><a href="details.php?id=302"><img src="img/media/jcole.jpg" alt="Jcole">
								<p>View Details</p></a></li>

								<li><a href="details.php?id=303"><img src="img/media/itunes.jpg" alt="Suggest">
									<p>View Details</p></a></li>
				</ul>
